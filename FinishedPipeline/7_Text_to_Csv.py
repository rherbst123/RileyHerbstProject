...
def main():
    input_filename = "FinishedPipeline/Outputs/TXT/11_Images_test.txt"  # The input text file
    output_filename = "FinishedPipeline/Outputs/CSV/11_Images_test.csv"   # The output CSV file
