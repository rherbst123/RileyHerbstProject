...
def initialize_sam():
    ...
    return SamAutomaticMaskGenerator(
        ...
        pred_iou_thresh=0.88,  # Threshold for the predicted Intersection over Union (IoU) score
...
if __name__ == "__main__":
    ...
    output_folder = "C:\\Users\\riley\\Desktop\\TESTFOLDER"  # Update this path as needed
